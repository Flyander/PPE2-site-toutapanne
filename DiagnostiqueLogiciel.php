    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12" style="	transform:  translateY(00px) ;">
          <h4 class="">Quel genre est votre panne Logiciel ?</h4>
        </div>
      </div>
    </div>
    <div class="container">                                        
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">Stockage plein</a>
            <a class="dropdown-item" href="#">Logiciel non installé</a>
            <a class="dropdown-item" href="#">Disque plein</a>
            <a class="dropdown-item" href="#">Windows ne demarre plus</a>
            <a class="dropdown-item" href="#">Session ne s'ouvre pas</a>
          </div>
        </div>
      </div>
      <div class="py-5">
