    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12" style="	transform:  translateY(00px) ;">
          <h4 class="">Quel genre est votre panne Pas de reseau ?</h4>
        </div>
      </div>
    </div>
    <div class="container">                                        
        ...
        Pas de reseau
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">Sur un PC</a>
            <a class="dropdown-item" href="#">Sur plusieurs PC</a>
            <a class="dropdown-item" href="#">Sur tout les PC</a>
          </div>
        </div>
      </div>
      <div class="py-5">
