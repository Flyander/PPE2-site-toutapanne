    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12" style="	transform:  translateY(00px) ;">
          <h4 class="">Quel genre est votre panne Demarrage inopérationel ?</h4>
        </div>
      </div>
    </div>
    <div class="container">                                        
        <div class="dropdown">
          <button type="button" class="btn btn-primary dropdown-toggle"href="#" style="background-color:#F7BE81" data-toggle="dropdown">
           Demarrage inopérationel
          </button>
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">Prise d'alimentation</a>
            <a class="dropdown-item" href="#">Cable d'alimentation</a>
          </div>
        </div>
      </div>
      <div class="py-5">
