    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12" style="	transform:  translateY(00px) ;">
          <h4 class="">Quel genre est votre panne materiel ?</h4>
        </div>
    ...
    <div class="container">                                        
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">Peripherique</a>
            <a class="dropdown-item" href="#">Allumage d'ecran</a>
            <a class="dropdown-item" href="#">demarrage PC</a>
          </div>
        </div>
      </div>
      <div class="py-5">
